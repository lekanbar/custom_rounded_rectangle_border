          ...
          rect.topLeft +
              new Offset(
                  borderRadius.topLeft.x +
                      (borderRadius.topLeft.x == 0 ? (leftSide?.width ?? 0.0) : 0.0),
                  (topSide?.width ?? 0.0) / 2),
          rect.topRight + new Offset(-borderRadius.topRight.x, (topSide?.width ?? 0.0) / 2),
          paint);
    }
          ...
          rect.topRight +
              new Offset(
                  ...
                  borderRadius.topRight.y +
                      (borderRadius.topRight.x == 0 ? (topSide?.width ?? 0.0) : 0.0)),
          rect.bottomRight +
              new Offset(-1 * (rightSide?.width ?? 0.0) / 2, -borderRadius.bottomRight.y),
          paint);
    }
          ...
          rect.bottomRight +
              new Offset(
                  -borderRadius.bottomRight.x -
                      (borderRadius.bottomRight.x == 0 ? (rightSide?.width ?? 0.0) : 0.0),
                  -1 * (bottomSide?.width ?? 0.0) / 2),
          rect.bottomLeft +
              new Offset(borderRadius.bottomLeft.x, -1 * (bottomSide?.width ?? 0.0) / 2),
          paint);
    }
          ...
          rect.bottomLeft +
              new Offset(
                  ...
                  -borderRadius.bottomLeft.y -
                      (borderRadius.bottomLeft.x == 0 ? (bottomSide?.width ?? 0.0) : 0.0)),
          rect.topLeft + new Offset((leftSide?.width ?? 0.0) / 2, borderRadius.topLeft.y),
          paint);
    }
  }
